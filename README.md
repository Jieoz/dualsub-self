...
当前正式版：**v0.5.9**。可从 [GitHub Releases](https://github.com/Jieoz/dualsub-self/releases/tag/v0.5.9) 下载 Chrome MV3 安装包。
...
9. 英文完整句超过约 14 词时会寻找两侧均可独立翻译的自然从句边界，单屏硬上限 16 词；不在短语、比较结构、关系从句主谓或短语动词内部硬切。没有可信自然边界时显式回退，且不改写、不重排、不丢词。
